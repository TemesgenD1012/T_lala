...
function Form() {
  ...
  return (
    ...
    >
      ...
      {waterIntake && (
        <p id="resultpar">
          የእርስዎ የሚመከረው ዕለታዊ ውሃ ነው። <strong>{waterIntake} liters</strong> or{" "}
          <strong>{Math.round(waterIntake * 4.227)}</strong> cups. And your body
          mass index is <strong>{bmi}</strong>.
        </p>
      )}
    </Box>
  );
