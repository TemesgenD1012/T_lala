        ...
        <div>
          ...
          <section>
            <div data-Aos="fade-left" className="info">
              <h2>በቀን ምን ያህል ውሃ መጠጣት አለቦት?</h2>
              <p>
                አጠቃላይ ምክሮች ለሴቶች 11.5 ኩባያ ወይም 91 አውንስ እና 15.5 ኩባያ ወይም 125 አውንስ
                ለወንዶች ይጠቁማሉ። ሆኖም፣ ልዩ ፍላጎቶች እንደ ክብደትዎ፣ የእንቅስቃሴዎ ደረጃ፣ አጠቃላይ ጤና እና
                እርስዎ በሚኖሩበት የአየር ንብረት ላይ በመመስረት ይለያያሉ። ንጹህ እና ንጹህ ውሃ በሚጠጡበት ጊዜ
                እርጥበት ለመቆየት ብቸኛው መንገድ አይደለም, አብዛኛውን ጊዜ ለሰውነትዎ ምርጥ ምርጫ ነው. ተጨማሪ
                የእርጥበት ምንጮች ከፍተኛ የውሃ ይዘት ያላቸውን ምግቦች (እንደ ሐብሐብ ወይም ስፒናች ያሉ) እና
                ሌሎች መጠጦች (ቡና እና ሶዳ ጨምሮ) ያካትታሉ።
              </p>{" "}
            </div>
          </section>
