...
function FoodTable({bloodType}) {
  ...
  //console.log("Find by Blood res : " + arr)
  var data = structurize(arr)
  //console.log("Structerize res : " + subArr)
        ...
        <TableBody>
          {
            ...
            <TableRow key={index} sx={{ '&:last-child td, &:last-child th': { border: 0 }, '&:nth-of-type(even)': {backgroundColor: '#ddd'} }}>
              <TableCell align="center" component="th" scope="row">{data[0][index]}</TableCell>
