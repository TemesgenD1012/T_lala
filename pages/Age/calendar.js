...
function FrontPage() {
  ...
  return (
    <div className="age_page_body page_body">
      {/* Input field for age */}
      ...
      <div className="calendar-cont">
        ...
        <div className="cal-parent" data-Aos="slide-down">
          ...
          <Stack spacing={2} direction="row">
            <Button variant="contained" onClick={calculateTime} id="button">
              Predict Personality
            </Button>
          </Stack>
        </div>
      ...
      <p>Your results</p>
          ...
          <div className="second">
            {seconds && (
              <p>
                <h1>Seconds-lived:</h1> {seconds} Seconds
              </p>
            )}
          </div>
          ...
          <div className="personality">
            {personality && (
              <p>
                {" "}
                <span>Predicted Personality:</span> {personality}
              </p>
            )}
          </div>
        </div>
